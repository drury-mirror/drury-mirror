...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    ...
    >
        <header className={'border-b'}>
            <div className={'h-16 flex items-center justify-between mx-auto max-w-[1280px]'}>
                <div className='flex gap-4 items-center'>
                    <Link className={'text-lg text-primary font-bold hover:scale-105'} href={'/'}>Drury Mirror</Link>
                    <NavigationMenu>
                        <NavigationMenuList>
